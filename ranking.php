                    ...
                    if ($result && $result->num_rows > 0):
                        ...
                        <tr class="<?php echo $isTop ? 'top-1' : ''; ?>" style="<?php echo $isTop ? 'border: 1px solid var(--neon-gold);' : ''; ?>">
                            <td style="font-family: 'Orbitron'; font-weight: bold; color: <?php echo $isTop ? 'var(--neon-gold)' : 'var(--neon-cyan)'; ?>;">
                                #<?php echo str_pad((int)$pos++, 2, '0', STR_PAD_LEFT); ?>
                            </td>
                            <td>
                                <div style="display: flex; align-items: center; gap: 15px;">
                                    <div style="width: 45px; height: 45px; border-radius: 50%; border: 2px solid <?php echo $isTop ? 'var(--neon-gold)' : 'var(--neon-cyan)'; ?>; background: url('<?php echo htmlspecialchars($foto_rank); ?>') center/cover; flex-shrink: 0;"></div>
                            ...
                            <td style="text-align: right; font-family: 'Orbitron'; font-weight: bold; color: var(--neon-cyan);">
                                <?php echo number_format((int)$row['xp'], 0, '', '.'); ?>
                            </td>
                        </tr>
                        <?php endwhile; 
                    else: ?>
